            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                <div className='flex items-center'>
                  ...
                  <ProductRating
                    activeClassname='fill-orange text-gray-300 h-4 w-4'
                    nonActiveClassname='fill-gray-300 text-orange h-4 w-4'
              ...
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                ...
                <div className='ml-4 rounded-sm bg-orange px-1 py-2 text-xs font-semibold uppercase text-white'>
              ...
              <div className='mt-8 flex items-center'>
                <button className='flex h-12 items-center justify-center rounded-sm border border-orange bg-orange/10 px-5 capitalize shadow-sm hover:bg-orange/5'>
                  <svg
