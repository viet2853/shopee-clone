        ...
        renderPopover={
          <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
            <div className='flex flex-col py-2 pr-28 pl-3'>
              <button
                className={`${
                  currentLanguage === locales.vi ? 'text-orange' : 'text-gray-800'
                } py-2 px-3 hover:text-orange`}
              ...
              <button
                className={`${
                  currentLanguage === locales.en ? 'text-orange' : 'text-gray-800'
                } py-2 px-3 hover:text-orange`}
